 ...
 * when clicked.
 */
(function(a){a.fn.h5lightbox=function(b){if(!this.length){return this}var c=a.extend(a.fn.h5lightbox.defaults,b);return this.each(function(){var f=a(this),e=f.attr(c.target),d=function(g){return(typeof g!=="undefined")};if(d(e)){f.wrap('<a class="'+c.wrapper_class+'" href="'+e+'"></a>')}a("a."+c.wrapper_class).click(function(i){i.preventDefault();var g=a(this).attr("href");if(a("#lightbox").length){a("#lb_img").html('<img src="'+g+'" />');a("#lightbox").show()}else{var h='<div id="lightbox"><p>Click to close</p><div id="lb_img"><img src="'+g+'" /></div></div>';a("body").append(h)}});a("#lightbox").live("click",function(){a("#lightbox").hide()})})};a.fn.h5lightbox.defaults={target:"data-large-src",wrapper_class:"lightbox"}})(jQuery);jQuery(function(a){a("img").h5lightbox()});
